...
<head>
    ...
    <title>Warko | Pembeli Register</title>
    ...
    <div class=" d-flex justify-content-center align-items-center my-5">
        <div class="register-box p-5 ">
            <div class="title mb-3">
                <h3 class="text-center">Selamat Datang <span class="text-primary">Pembeli</span></h3>
                <p class="text-secondary text-center">Masukin data kamu dan mulai belanja sekarang juga</p>
            </div>
            <form method="POST" action="{{ route('do.pembeliregister') }}">
                @csrf
                <div class="mb-3">
